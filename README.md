...
OpenUI spawns Claude Code instances using the `claude` CLI. This works seamlessly with:
...
When starting sessions with a branch, OpenUI creates git worktrees automatically:

- Each branch gets its own worktree for isolation
